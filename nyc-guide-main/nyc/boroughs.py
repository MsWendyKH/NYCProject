boroughs = {
    'brooklyn': {
        'beaches': {
            'brighton beach': { 
                'img_link': 'https://newyork.cbslocal.com/wp-content/uploads/sites/14578484/2011/07/coney-island-beach.jpg?w=420&h=316&crop=1',
            ...
            'coney island': {
                'img_link': 'https://www.bklynlibrary.org/sites/default/files/images/blog-bkology/cbh/bhs_v1973.4.1511_t.jpg',
            ...
            'manhattan beach': {
                'img_link': 'https://media.cntraveler.com/photos/5e13623e402e42000815162d/16:9/w_2560,c_limit/manhattanbeach-2020-EA564T.jpg',
    ...
    'bronx': {
        'beaches': {
            'orchard beach': {
                'img_link': 'http://www.visiting-newyork.net/resources/bronx/bronx-orchard-beach-3.jpg',
        ...
        'zoos': {
            'bronx zoo': {
                'img_link': 'https://media.timeout.com/images/105672937/image.jpg',
    ...
    'manhattan': {
        'food': {
            'cheeky sandwiches': {
                'img_link': 'https://media.timeout.com/images/105511818/750/422/image.jpg',
            ...
            'veselka': {
                'img_link': 'https://untappedcities.com/wp-content/uploads/2016/08/Veselkastorefront70s-jamesandmurrayphotography-yc-untappedcities.jpg',
                'description': 'Borscht & pierogi are menu highlights at this cheap, no-frills Ukrainian eatery open 24 hours a day.'
            }
        },
        'parks': {
            'central park': {
                'img_link': 'https://nypost.com/wp-content/uploads/sites/2/2018/07/central-park-conservancy.jpg?quality=80&strip=all',
            ...
            'riverside park': {
                'img_link': 'http://riversideparknyc.org/wp-content/uploads/2012/10/RPS-Photos-2.jpg',
            ...
            'the highline':  {
                'img_link': 'https://media.timeout.com/images/102540127/630/472/image.jpg',
            ...
            'washington square park':  {
                'img_link': 'https://thumbor.thedailymeal.com/DSzz48ZFjmSQyKsaw1u6CvO1hDI=//https://www.theactivetimes.com/sites/default/files/story/2019/iStock-1162428342.jpg',
    ...
    'queens': {
        'airports': {
            'john f kennedy international airport': {
                'img_link': 'https://s28477.pcdn.co/wp-content/uploads/2018/01/JFK_1-984x554.jpg',
        ...
        'beaches': {
            'rockaway beaches': {
                'img_link': 'https://static01.nyt.com/images/2020/08/02/realestate/31DOMESTIC-ROCKAWAY-slide-OJH5/31DOMESTIC-ROCKAWAY-slide-OJH5-mobileMasterAt3x.jpg',
    ...
    'staten island': {
        'beaches': {
            ...
            'south beach': {
                'img_link': 'https://i.pinimg.com/originals/2b/c6/cc/2bc6ccc9a6512b6c93991549904b758a.jpg',
            ...
            'wolfe\'s pond beach': {
                'img_link': 'https://www.nycgovparks.org/photo_gallery/full_size/21442.jpg',
        ...
        'food': {
            'lee\'s tavern': {
                'img_link': 'https://thepizzasnob.files.wordpress.com/2013/02/lees-bar-resize.jpg',
                'description': 'Family-run neighborhood pub with photos on the wall serving a range of pizza & brews.'
            },
            'ralph\'s famous italian ices': {
                'img_link': 'https://media-cdn.tripadvisor.com/media/photo-s/06/51/b8/d3/ralphs-in-syosset-ny.jpg',
                'description': 'Staten Island-born chain dispensing Italian ices & ice cream in 100-plus flavors since 1928.'
            },
            'royal crown bakery': {
                'img_link': 'https://media-cdn.tripadvisor.com/media/photo-s/0f/29/50/1a/royal-crown-bakery.jpg',
